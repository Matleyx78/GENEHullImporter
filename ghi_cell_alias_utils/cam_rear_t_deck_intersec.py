#   REAR TRANSOM DECK INTERSECTION
#   output:
...
def rt_deck_inter_cell_mapping():
    Sections = {}
    name = rt_deck_inter_name()
    rows = rt_deck_inter_rows()
    for key1 in name:
        Sections[key1] = {}
        for key2 in rows:
            Sections[key1][key2] = {}
...
def rt_deck_inter_value(spreadsheet):
    sec_value = {}
    section = rt_deck_inter_cell_mapping()
    for key1 in section:
        sec_value[key1] = {}
