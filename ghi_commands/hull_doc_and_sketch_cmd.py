...
from ghi_obj_creation.center_line import center_line_creation
from ghi_obj_creation.hard_and_sheer import hard_and_sheer_creation
...
class DocSketchHullCmd:
    ...
    def Activated(self):
        ...
        center_line_creation(doc_name, body_name)
        # creo la keel line
